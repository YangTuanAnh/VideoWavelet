...
import pandas as pd
from .config import DATA_DIR, VQA_SEED, VQA_MODEL_NAME
...
if __name__ == "__main__":
    ...
    for idx, row in pbar:
        ...
        response = client.models.generate_content(
            ...
            contents=[
                """
                Provide a question and answer for visual question answering, the question should also include some description for image retrieval.
